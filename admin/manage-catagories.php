        ...
        <div class="container dashboard__container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="manage-users.php"><i class="uil uil-house-user"></i>
                            <h5>Manage User</h5>
                        </a>
                    </li>
                    <li>
                        <a href="add-catagory.php"><i class="uil uil-pen"></i>
                            <h5>Add Catagory</h5>
                        </a>
                    </li>
                    <li>
                        <a href="manage-catagories.php" class="active"><i class="uil uil-list-ul"></i>
            ...
            <main>
                ...
                <table>
                    ...
                    <tbody>
                            <tr>
                                <td>Travel</td>
                                <td><a href="edit-catagory.php" class="btn sm">Edit</a></td>
